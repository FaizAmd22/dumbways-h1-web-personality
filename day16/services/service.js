...
async function projectDetail(req, res) {
    ...
    const query = `SELECT tb_projects.id, tb_projects.name, tb_projects.start_date, tb_projects.end_date, tb_projects.description, tb_projects.node, tb_projects.next, tb_projects.react, tb_projects.typescript, tb_projects.image, tb_projects.duration, tb_projects.duration, 
    users.name AS author FROM tb_projects LEFT JOIN users ON
